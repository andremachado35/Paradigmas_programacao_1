	public class CofrePonto2<E extends Ponto2D> extends Cofre<Ponto2D> {
		public CofrePonto2() { super(); }
		public CofrePonto2(E elem) { super(); super.guarda(elem); }
		public void guarda(E elem) { super.guarda(elem); }
		public Ponto2D consulta() { return super.consulta(); }
