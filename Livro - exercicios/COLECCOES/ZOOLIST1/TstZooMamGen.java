...
public class TstZooMamGen {
    ...
    public static ArrayList<Coelho> criaCoelhos() {
        ...
        public static ZooMamGen main(String[] args) {
        // Variável do tipo ZooMam
            ZooMamGen zoo = new ZooMamGen();
            // Array auxiliar
            ...
            // mais !!
            ArrayList<Gato> gatos = new ArrayList<Gato>();
            gatos.add(new Gato("WHAT","PER", 2));
            gatos.add(new Gato("BILL", "CHU", 2));
            // e agora vamos inserir os gatos no zoo
